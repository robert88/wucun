require("/public/js/lib/jQeasing.js");
require("/public/js/lib/jquery.masonry.min.js");
/*
...
var vuer = new Vue({
	...
	data:{
		imageGroup:[
			{img:"/public/images/A/1.png",src:""},
			{img:"/public/images/A/2.png",src:""},
			{img:"/public/images/A/3.png",src:""},
			{img:"/public/images/A/4.png",src:""},
			{img:"/public/images/A/5.png",src:""},
			{img:"/public/images/A/6.png",src:""},
			{img:"/public/images/A/7.png",src:""},
			{img:"/public/images/A/8.png",src:""},
			{img:"/public/images/A/9.png",src:""},
			{img:"/public/images/A/10.png",src:""},

		]
	},
	updated:function () {

		var $li =  $(".item").filter(function (idx,val) {
			return curindex<idx;
		});
		$li.css({ opacity: 0});

		setTimeout(function () {
			$li.animate({ opacity: 1},800);
			container.masonry( 'appended',$li,true);
			curindex = vuer.imageGroup.length;
		},17);
	}

});

var curindex = vuer.imageGroup.length;
	...
	function tores() {
		...
		var tmpWid = $(".wrap").width();

		var column = Math.floor(tmpWid / 330);
...
$(".load-more").click(function () {
	...
	vuer.imageGroup = vuer.imageGroup.concat([
		{img:"/public/images/A/2.png",src:""},
		{img:"/public/images/A/3.png",src:""},
		{img:"/public/images/A/4.png",src:""},
		{img:"/public/images/A/5.png",src:""}]);
